...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <p class="text-sm text-slate-500">Kelola data lokasi utama</p>
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-6 py-3 text-center">
                            <span
                                ...
                                $l->ruangan_count }}</span>
                        </td>
                        <td class="px-6 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('master.lokasi.edit', $l) }}"
                                ...
                                <form action="{{ route('master.lokasi.destroy', $l) }}" method="POST"
