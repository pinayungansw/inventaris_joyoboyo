    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <a href="{{ route('aset.index') }}" 
               class="group rounded-2xl bg-white border border-[#E2E8F0] p-5 shadow-sm transition-all hover:shadow-md hover:border-[#1C7791]/30 active:scale-[0.98]">
                <div class="flex items-start justify-between">
                    <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Aset</p>
                    <svg class="w-4 h-4 text-slate-300 group-hover:text-[#1C7791] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('aset.index', ['kondisi' => 'Baik']) }}" 
               class="group rounded-2xl bg-white border border-[#E2E8F0] p-5 shadow-sm transition-all hover:shadow-md hover:border-emerald-200 active:scale-[0.98]">
                <div class="flex items-start justify-between">
            ...
            <a href="{{ route('aset.index', ['kondisi' => 'Layak']) }}" 
               class="group rounded-2xl bg-white border border-[#E2E8F0] p-5 shadow-sm transition-all hover:shadow-md hover:border-amber-200 active:scale-[0.98]">
                <div class="flex items-start justify-between">
                    <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Kondisi Layak</p>
                    <svg class="w-4 h-4 text-slate-300 group-hover:text-amber-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('aset.index', ['kondisi' => 'Rusak']) }}" 
               class="group rounded-2xl bg-white border border-[#E2E8F0] p-5 shadow-sm transition-all hover:shadow-md hover:border-red-200 active:scale-[0.98]">
                <div class="flex items-start justify-between">
        ...
        <div class="rounded-2xl bg-white shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="bg-slate-50 text-slate-500 border-b border-slate-100">
                        <tr>
                            <th class="px-6 py-4 text-left font-medium uppercase tracking-wider text-[10px]">No. Seri
                                Inventaris</th>
                                        ...
                                        <tr class="hover:bg-slate-50/50 transition-colors">
                                            <td class="px-6 py-4 font-mono text-xs font-bold text-[#1C7791]">
                                                <a href="{{ route('aset.show', $a) }}"
                                                    class="hover:underline">{{ $a->nomor_seri_inventaris ?? '-' }}</a>
                                            </td>
